...
class FinancialRAG:
    ...
    async def _get_recent_transactions(
        ...
        return [
            ...
            {
                "date": "2026-01-27",
                "description": "AMAZON.COM*Z1234ABC",
                "amount": 45.99,
                "category": "Shopping & Retail",
            },
            {
                "date": "2026-01-27",
                "description": "UBER *TRIP X9Y8Z7",
                "amount": 22.50,
        ...
        return [
            {
                ...
                "amount": 15.99,
                "frequency": "monthly",
                "last_charge": "2026-01-26",
            },
            {
                "merchant": "Spotify",
                "amount": 10.99,
                "frequency": "monthly",
                "last_charge": "2026-01-24",
            },
            {
