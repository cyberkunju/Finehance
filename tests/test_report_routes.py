...
class TestReportRoutes:
    ...
    async def test_generate_report_basic(self, async_client: AsyncClient, test_user, test_db):
    ...
    async def test_export_report_csv(self, async_client: AsyncClient, test_user, test_db):
        """Test CSV export."""
        user_id = test_user.id
        today = date.today()
    ...
    async def test_export_report_pdf(self, async_client: AsyncClient, test_user, test_db):
        """Test PDF export."""
        user_id = test_user.id
        today = date.today()
