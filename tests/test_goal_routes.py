...
class TestGoalRoutes:
    ...
    async def test_create_goal_without_deadline(self, async_client: AsyncClient, test_user, test_db):
    ...
    async def test_create_goal_invalid_target_amount(self, async_client: AsyncClient, test_user, test_db):
    ...
    async def test_update_goal_progress(self, async_client: AsyncClient, test_user, test_db):
        ...
        # Update progress
        response = await async_client.post(
            f"/api/goals/{goal.id}/progress?user_id={user_id}",
            json={"amount": "200.00"}
        )
    ...
    async def test_update_goal_progress_achievement(self, async_client: AsyncClient, test_user, test_db):
    ...
    async def test_update_goal_not_found(self, async_client: AsyncClient, test_user, test_db):
        ...
        response = await async_client.put(
            f"/api/goals/{fake_id}?user_id={user_id}",
            json={"name": "Updated"}
        )
