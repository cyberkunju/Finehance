...
class TestFileImportRoutes:
    ...
    async def test_import_transactions_csv(
...
"""
        ...
        response = await async_client.post(
            f"/api/import/transactions?user_id={user_id}",
            files=files
        )
    ...
    async def test_import_transactions_invalid_format(
        ...
        # Create invalid file
        files = {
            "file": ("transactions.txt", io.BytesIO(b"invalid content"), "text/plain")
        }
...
"""
    ...
    async def test_export_transactions_basic(
        self, async_client: AsyncClient, test_user, test_db
    ):
        ...
        response = await async_client.get(
            f"/api/export/transactions?user_id={user_id}"
        )
    ...
    async def test_export_transactions_empty(
        self, async_client: AsyncClient, test_user, test_db
    ):
    ...
    async def test_download_template_xlsx(
        self, async_client: AsyncClient
    ):
    ...
    async def test_download_template_invalid_format(
        self, async_client: AsyncClient
    ):
    ...
    async def test_download_template_default_format(
        self, async_client: AsyncClient
    ):
