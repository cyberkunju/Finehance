...
class TestGoalService:
    ...
    async def test_create_goal_with_initial_amount(
        self,
        goal_service,
        test_user,
        db_session
    ...
    async def test_create_goal_invalid_target(
        self,
        goal_service,
        test_user
    ):
    ...
    async def test_list_goals_by_status(
        self,
        goal_service,
        test_user,
        db_session
    ...
    async def test_goal_achievement_detection(
        self,
        goal_service,
        test_user,
        db_session
    ...
    async def test_update_goal_progress_from_transaction(
        self,
        goal_service,
        test_user,
        db_session
    ...
    async def test_goal_risk_detection(
        self,
        goal_service,
        test_user,
        db_session
    ...
    async def test_goal_no_risk_on_track(
        self,
        goal_service,
        test_user,
        db_session
